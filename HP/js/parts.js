'use strict'; 
{
    ...
    <div class="header_menu flex_header">
        <a href="./index.html"><img src="../images/junk_icon.png"><p id="name_header">Girl's JUNK</p></a>
    ...
    <div class="nav">
        ...
        <ul class="nav_list">
            ...
            <li class="nav_item"><a href="./menu.html">今週の出勤メンバー</a></li>
            <li class="nav_item"><a href="./item.html">イベント情報</a></li>
            <li class="nav_item"><a href="./shop.html">予約・問い合わせ</a></li>
            </ul>
        </nav>
    </div>
...

{
    ...
    <div class="footer_info">
        ...
        <div class="footer_sns">
            ...
            <a class="line" href="https://lin.ee/rbLo70R"><span class="f-fa fa-brands fa-line" style="color: #06c755;"></span></a>    
        </div>
    </div>
